...
function initTools( common, initInfo ){
	...
	// 			// extract tools files using Node Mode
	// 			if( __nodejsModeUsage && process.env.NODE_ENV ){

	// 				if( process.env.NODE_ENV === 'production' ){ 
	// 					if( architecture[i].production && typeof architecture[i].production != "undefined" ){
	// 						toolFiles = architecture[i].production.toolFiles; 
	// 					} else {
	// 						toolFiles = architecture[i].toolFiles; 
	// 					}
	// 				} else if( process.env.NODE_ENV === 'development' ){ 
	// 					if( architecture[i].production && typeof architecture[i].production != "undefined" ){
	// 						toolFiles = architecture[i].development.toolFiles; 
	// 					} else {
	// 						toolFiles = architecture[i].toolFiles; 
	// 					}
	// 				}
	...
	// 				if( architecture[i].toolFiles && typeof architecture[i].toolFiles != "undefined" ){
	// 					toolFiles = architecture[i].toolFiles;
	// 				} else if( architecture[i].production.toolFiles && typeof architecture[i].production.toolFiles != "undefined" ){
	// 					toolFiles = architecture[i].production.toolFiles;
	// 				} else if( architecture[i].development.toolFiles && typeof architecture[i].development.toolFiles != "undefined" ){
	// 					toolFiles = architecture[i].development.toolFiles;
	// 				}
	// 			}
