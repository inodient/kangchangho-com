	...
	get : function(){
		try{
			if( typeof initInfo.protocol != "undefined" ){
				...
				if( fs.existsSync( path.join( process.cwd(), "core-properties", "https", keyFileName) ) ){
					return path.join( process.cwd(), "core-properties", "https", keyFileName);
				} else{
	...
	get : function(){
		try{
			if( typeof initInfo.protocol != "undefined" ){
				...
				if( fs.existsSync( path.join( process.cwd(), "core-properties", "https", certFileName) ) ){
					return path.join( process.cwd(), "core-properties", "https", certFileName);
				} else{
