...
Object.defineProperty(global, "__mysqlQueriesXML", {
	get : function(){
		if( fs.existsSync(path.join( process.cwd(), architecture[ "tools-submodules" ], "db", "queries", "query.xml" ) ) ){
			return path.join( process.cwd(), architecture[ "tools-submodules" ], "db", "queries", "query.xml" );
		} else{
			return path.join( path.dirname( require.main.filename ), "node_modules", "summer-mvc", architecture[ "tools-submodules" ], "db", "queries", "query.xml" );
		}
	}
} );
