	...
	get : function(){
		try{
			if( typeof initInfo.protocol != "undefined" ){
				...
				if( fs.existsSync( path.join( __corePropertiesPath, "https", keyFileName) ) ){
					return path.join( __corePropertiesPath, "https", keyFileName);
				} else{
	...
	get : function(){
		try{
			if( typeof initInfo.protocol != "undefined" ){
				...
				if( fs.existsSync( path.join( __corePropertiesPath, "https", certFileName) ) ){
					return path.join( __corePropertiesPath, "https", certFileName);
				} else{
