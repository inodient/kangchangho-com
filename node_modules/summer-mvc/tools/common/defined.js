	...
	get : function(){
		try{
			if( typeof initInfo.protocol != "undefined" ){
				...
				if( fs.existsSync( path.join( __httpsKeyFilePath, "https", keyFileName) ) ){
					return path.join( __httpsKeyFilePath, "https", keyFileName);
				} else{
	...
	get : function(){
		try{
			if( typeof initInfo.protocol != "undefined" ){
				...
				if( fs.existsSync( path.join( __httpsKeyFilePath, "https", certFileName) ) ){
					return path.join( __httpsKeyFilePath, "https", certFileName);
				} else{
