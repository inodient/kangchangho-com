		...
		if( connection ){
			...
			.then( function( results ){
				...
				if( results.recordsets.length ){
					var recordsets = results.recordsets[0];

	    //    			for( var i=0; i<recordsets.length; i++ ){
					// 	for( key in recordsets[i] ){
					// 		if( typeof ( (recordsets[i])[key] ) === "string" ){
					// 			(recordsets[i])[key] = decodeURIComponent( (recordsets[i])[key] );
					// 		}
					// 	}
					// }

					results.recordsets[0] = recordsets;
				}
