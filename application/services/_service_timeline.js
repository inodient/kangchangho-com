...
var dbExecutorTimeline = require( require("path").join( __runningPath, "application", "model", "_dbExecutor_timeline.js" ) );
...
exports.addTimeline = function( connection, parameter ){
  return new Promise( function(resolve, reject){
    dbExecutorTimeline.addTimeline( connection, parameter )
    .then( function( results ){
      logger.debug( results.results.insertId )
      resolve( {"status":"succeed", "timelineId":results.results.insertId})
    } )
    .catch( function(err){
      reject( err );
    } );
...
function extractContentText( contentHTML, lang ){
  return new Promise( function(resolve, reject){
    try {
      ...
      $("p, h1, h2, h3, h4, h5, h6, span, li, th, td, code, blockquote").each( function(){
